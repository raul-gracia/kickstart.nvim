...
-- Turn search highlight on, and remove highlight whenever I press escape
vim.o.hlsearch = true
...
require('telescope').setup {
  ...
  extensions = {
    media_files = {
      filetypes = { 'png', 'mp4', 'webp', 'webm', 'pdf', 'jpg', 'jpeg' },
      find_cmd = 'rg',
    },
  },
}
...
vim.keymap.set('n', '<leader>xx', function()
  ...
  desc = 'Toggle [X] Trouble',
})
vim.keymap.set('n', '<leader>xw', function()
  require('trouble').toggle 'workspace_diagnostics'
end, {
  desc = 'Toggle [X] Trouble [W]orkspace Diagnostics',
})
vim.keymap.set('n', '<leader>xd', function()
  require('trouble').toggle 'document_diagnostics'
end, {
  desc = 'Toggle [X] Trouble [D]ocument Diagnostics',
})
vim.keymap.set('n', '<leader>xq', function()
  require('trouble').toggle 'quickfix'
end, {
  desc = 'Toggle [X] Trouble [Q]uickfix',
})
vim.keymap.set('n', '<leader>xl', function()
  require('trouble').toggle 'loclist'
end, {
  desc = 'Toggle [X] Trouble [L]oclist',
})
vim.keymap.set('n', 'gR', function()
  require('trouble').toggle 'lsp_references'
end, {
  desc = 'Toggle [X] Trouble [R]eferences',
})
...
vim.keymap.set('n', '<leader>tf', require('nvim-tree.api').tree.open, {
  desc = 'Nvim [T]ree [F]ocus',
})
